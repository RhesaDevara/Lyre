                    ...
                    <div class="col-12 col-md-6 bg-primary text-white">
                        <div class="d-flex align-items-center justify-content-center h-100">
                            <div class="col-10 col-xl-8 py-3 text-center">
                                ...
                                <p class="lead m-0 mb-3">Do you want to register as a Applicant? <br><a
                                        class="link-offset-2 link-offset-3-hover link-underline-light text-light"
                                        href="daftar_user.php">Let's
                                        Go Here!!</a>
                                </p>
                                ...
                                <form method="post" action="daftar_company_proses.php">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="nama_perusahaan"
                                            name="nama_perusahaan" min="0" placeholder="Masukkan nama perusahaan"
                                            required>
                                    </div>
                                    <div class="mb-3">
                                        ...
                                        <input type="email" class="form-control" id="email_perusahaan"
                                            name="email_perusahaan" placeholder="Masukkan email perusahaan" required>
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="password" class="form-control" id="confirm-password"
                                            name="confirm-password" placeholder="Ulangi password untuk kofirmasi"
                                            required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="name" class="form-label">Nomor Telepon <span
                                                class="text-danger">*</span></label>
                                        <input type="text" class="form-control" id="no_telp" name="no_telp"
                                            placeholder="Masukkan nomor telepon" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="dob" class="form-label">Alamat Perusahaan <span
                                                class="text-danger">*</span></label>
                                        <input type="text" class="form-control" id="alamat_perusahaan"
                                            name="alamat_perusahaan" placeholder="Masukkan alamat perusahaan" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="deskripsi_perusahaan" class="form-label">Deskripsi
                                            Perusahaan <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" id="deskripsi_perusahaan"
                                            name="deskripsi_perusahaan" placeholder="Masukkan deskripsi perusahaan"
                                            required>
                                    </div>
                                    <div class="mb-3">
                                        <div class="d-grid">
