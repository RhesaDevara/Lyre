                    ...
                    <div class="col-xl-9 col-md-8 mb-6 mb-md-0">
                        ...
                        while ($data = $sql->fetch()) {
                            ...
                            if ($interval->y > 0) {
                                ...
                                $selisih = $interval->h . " Jam yang lalu";
                            } elseif ($interval->i > 0) {
                                $selisih = $interval->i . " Menit yang lalu";
                            } else {
                                $selisih = $interval->s . " Detik yang lalu";
                            }
                                    ...
                                    <div>
                                        <div class="d-xl-flex">
                                            <div class="mb-3 mb-md-0 text-center">
                                                <img src="<?php echo $dataPerusahaan['logo']; ?>" alt="course" class="rounded logo-tes mt-md-2">
                                            </div>
