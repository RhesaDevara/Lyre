...
if ($countSoal == 0) {
    ...
    $sqlHasil = $koneksiPdo->prepare("INSERT INTO hasil_tes(id_lamaran, id_lowongan, nilai) values ('$id_lamaran','$id_lowongan', 100)");
    $sqlHasil->execute();

    echo "<script>alert('Tes Selesai! Lowongan tidak memiliki tes.');</script>";
