...
<body>
      ...
      <div class="d-flex flex-column profile-container-80">
        <div class="d-flex flex-row p-2">
          <div class="p-2 profile-container-30">
            <center> <img src="assets/img/profile.png" class="img-profile">
          </div>
          <div class="p-2 profile-container-70">
            <h1 style="margin-top: 30px;">
              <?php echo $data['nama']; ?>
            </h1>
            <?php echo $data['email'] . " / " . $data['nomor_telepon']; ?>
            <?php
            if (isset($_SESSION['user'])) { ?>
              <br><button class="btn btn-warning mt-2" data-toggle='modal' data-target='#editProfile'>Edit
                Profile</button>
            <?php } ?>
          </div>
        </div>
          ...
          while ($dataPendidikan = $sqlPendidikan->fetch()) {
            ...
            <form method="post">
              <div class="d-flex flex-row">
                <div>
                  <h5 class="background-text px-2 py-1">
                ...
                <div class="pt-1">
                  <?php
                  if (isset($_SESSION['user'])) { ?>
                    <i class="fa-solid fa-pencil ms-3 mt-1" style="color: #20444F;" data-toggle='modal'
                      data-target='#editModal<?php echo $i ?>'></i>
                  <?php }
                  ?>
        ...
        <div class="d-flex flex-row p-5 profile-container-80">
          <div class="p-2 profile-container-100">
            ...
            while ($dataPengalaman = $sqlPengalaman->fetch()) {
                ...
                <a class="list-group-item list-group-item-action flex-column align-items-start">
                  <div class="d-flex w-100 justify-content-between">
                    <div class="d-flex flex-row">
                      ...
                      <?php
                      if (isset($_SESSION['user'])) { ?>
                        <div class="pt-1"> <i class="fa-solid fa-pencil ms-3 mt-1" style="color: #20444F;"
                            data-toggle='modal' data-target='#editPengalaman<?php echo $k; ?>'></i> </div>
                      <?php }
                      ?>
              ...
              <div class="modal fade" id="editPengalaman<?php echo $k; ?>" tabindex="-1" role="dialog"
            ...
            <?php
            if (isset($_SESSION['user'])) { ?>
              <button class="btn btn-secondary mt-2" data-toggle="modal" data-target="#tambahPengalaman">+ Tambahkan
        ...
        <div class="p-3 mt-5 profile-container-20">
          <div class="d-flex flex-row">
            ...
            if (isset($_SESSION['user'])) { ?>
              ...
              <div class="pt-2"> <i class="fa-solid fa-pencil ms-3 mt-1" style="color: #20444F;" data-toggle='modal'
                  data-target='#editKeahlianModal'></i> </h3>
              </div>
            <?php }
            ?>
          </div>
          ...
          while ($dataKeahlian = $sqlKeahlian->fetch()) {
            ...
            <div class="d-flex flex-row px-4">
              <div class="background-text mb-2 pt-1" style="width:100%; height: 35px;">
                <center>
          ...
          if (isset($_SESSION['user'])) {
            if ($countKeahlian < 10) {
              ?>
              <center><button class="btn btn-secondary mt-2" data-toggle='modal' data-target='#tambahKeahlianModal'> +
                  Tambahkan Keahlian </button></center>
              <?php
            }
          }
          ?>
    ...
    <div class="d-flex flex-row">
      <div class="px-5 pb-5 profile-container-80" style="text-align: justify">
        ...
        while ($dataSertifikat = $sqlSertifikat->fetch()) {
            ...
            <a class="list-group-item list-group-item-action flex-column align-items-start p-3">
              <div class="d-flex w-100 justify-content-between">
                <div class="d-flex flex-row">
                  ...
                  <?php
                  if (isset($_SESSION['user'])) { ?>
                    <div class="pt-1"> <i class="fa-solid fa-pencil ms-3 mt-1" style="color: #20444F;" data-toggle='modal'
                        data-target='#editSertifikat<?php echo $m; ?>'></i> </div>
                  <?php }
                  ?>
                </div>
              </div>
          ...
          <div class="modal fade" id="editSertifikat<?php echo $m; ?>" tabindex="-1" role="dialog"
        ...
        <?php
        if (isset($_SESSION['user'])) { ?>
          <button class="btn btn-secondary mt-2" data-toggle='modal' data-target='#tambahSertifikat'> + Tambahkan
            Sertifikat </button>
        <?php } ?>
      </div>
      <div class="p-2">
  ...
  <!-- Modal ubah keahlian -->
  <div class="modal fade" id="editKeahlianModal" tabindex="-1" role="dialog" aria-labelledby="editKeahlianModalLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
            ...
            while ($dataEditKeahlian = $sqlKeahlian1->fetch()) { ?>
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="keahlian" name="keahlian<?php echo $l; ?>"
                  placeholder="Kotlin / Java / PHP / Javascript"
                  value="<?php echo $dataEditKeahlian['nama_keahlian']; ?>">
              </div>
              <?php $l++;
            } ?>
        </div>
  ...
  <!-- Modal edit profile -->
  <div class="modal fade" id="editProfile" tabindex="-1" role="dialog" aria-labelledby="editAboutModalLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <form method="post">
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="nama" name="nama" placeholder="Masukkan nama lengkap anda"
                value="<?php echo $_SESSION['user']['nama']; ?> "></textarea>
            </div>
            <div class="form-group">
              <label for="recipient-name" class="col-form-label">Email:</label>
              <input type="email" class="form-control" id="email" name="email" placeholder="Masukkan email anda"
                value="<?php echo $_SESSION['user']['email']; ?> "></textarea>
            </div>
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="nomor_telepon" name="nomor_telepon" placeholder="08**********"
                value="<?php echo $_SESSION['user']['nomor_telepon']; ?> "></textarea>
            </div>
            <div class="form-group">
              ...
              <textarea class="form-control" id="tentang_anda" name="tentang_anda"
                placeholder="Tuliskan tentang diri anda"><?php echo $_SESSION['user']['about']; ?></textarea>
            </div>
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-dismiss="modal">Tutup</button>
  ...
  <div class="modal fade" id="tambahKeahlianModal" tabindex="-1" role="dialog"
    aria-labelledby="tambahKeahlianModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <form method="post">
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="keahlian" name="keahlian"
                placeholder="Kotlin / Java / PHP / Javascript"></textarea>
            </div>
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-dismiss="modal">Tutup</button>
  ...
  <div class="modal fade" id="tambahSertifikat" tabindex="-1" role="dialog" aria-labelledby="tambahKeahlianModalLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
  ...
  <!-- Modal tambah pengalaman -->
  <div class="modal fade" id="tambahPengalaman" tabindex="-1" role="dialog" aria-labelledby="tambahPengalamanLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
