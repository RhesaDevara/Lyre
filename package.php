	...
	<table align=right class="table table-striped table-responsive-md table-hover mt-5">
		...
		<?php while ($data = $ambil->fetch_assoc()) {  ?>
			<tr align="center">
				...
				<td>
					<a href="package_ubah.php?&id=<?php echo $data['id_paket']; ?>" class="btn btn-warning btn-sm">Edit</a>
					<a href="package_hapus.php?&id=<?php echo $data['id_paket']; ?>" class="btn btn-danger btn-sm">Delete</a>
				</td>
			</tr>
			<?php $nomor++; ?>
		<?php } ?>
