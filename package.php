                    ...
                    <thead>
                        <tr>
                            ...
                            <th>
                                Package Name
                                <a
                                    href="?keyword=<?php echo htmlspecialchars($keyword); ?>&orderBy=nama_paket&sort=<?php echo ($orderBy === 'nama_paket' && $orderDirection === 'ASC') ? 'desc' : 'asc'; ?>">
                                    <i
                                        class="text-dark fa fa-sort <?php echo ($orderBy === 'nama_paket' && $orderDirection === 'ASC') ? 'asc' : 'desc'; ?>"></i>
                                </a>
                            </th>
                            <th>
                                Kuota
                                <a
                                    href="?keyword=<?php echo htmlspecialchars($keyword); ?>&orderBy=kuota&sort=<?php echo ($orderBy === 'kuota' && $orderDirection === 'ASC') ? 'desc' : 'asc'; ?>">
                                    <i
                                        class="text-dark fa fa-sort <?php echo ($orderBy === 'kuota' && $orderDirection === 'ASC') ? 'asc' : 'desc'; ?>"></i>
                                </a>
                            </th>
                            <th>
                                Harga
                                <a
                                    href="?keyword=<?php echo htmlspecialchars($keyword); ?>&orderBy=harga&sort=<?php echo ($orderBy === 'harga' && $orderDirection === 'ASC') ? 'desc' : 'asc'; ?>">
                                    <i
                                        class="text-dark fa fa-sort <?php echo ($orderBy === 'harga' && $orderDirection === 'ASC') ? 'asc' : 'desc'; ?>"></i>
                                </a>
                            </th>
                            <th>Actions</th>
                        </tr>
