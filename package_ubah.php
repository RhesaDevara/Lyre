...
<body>
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" name="name" value="<?php echo $pecah['nama_package']; ?>" placeholder="Enter package name" required>
...
if (isset($_POST['ubah'])) {
  ...
  $koneksi->query("UPDATE package SET nama_package='$nama', kuota='$kuota', harga='$harga' WHERE id_package='$_GET[id]'");
