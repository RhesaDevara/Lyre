                                ...
                                <div>
                                    ...
                                    <form method="post" enctype="multipart/form-data">
                                        <div class="row g-3">
                                            ...
                                            <div class="col-12">
                                                <button name="apply" class="btn btn-primary w-100" onclick='return confirm("Apakah Anda Yakin?")' type="submit">Lamar
                                                    Sekarang</button>
                                            </div>
                                        </div>
                                    </form>
                    ...
                    <?php if (isset($_SESSION['company']['id_perusahaan']) && $_SESSION['company']['id_perusahaan'] == $id_perusahaan) { ?>
                        ...
                        <ul class="nav nav-tabs mb-3" id="detail-lowongan" role="tablist">
                            <li class="nav-item w-25" role="presentation">
                                <a data-bs-tab-init class="nav-link active" id="detail-lowongan-deskripsi" href="<?php echo "detail_lowongan.php?id_lowongan=$id_lowongan"; ?>" role="tab" aria-controls="detail-lowongan-deskripsi" aria-selected="true"><i class="fa-solid fa-info-circle fa-fw me-2"></i>Deskripsi</a>
                            </li>
                            <li class="nav-item w-25" role="presentation">
                        ...
                        <div class="tab-content" id="detail-lowongan">
                            <div class="tab-pane fade show active" id="detail-lowongan-deskripsi" role="tabpanel" aria-labelledby="detail-lowongan-deskripsi">
                                <div class="mb-5">
                                    <h4 class="mb-3">Deskripsi Pekerjaan</h4>
                            ...
                            <div class="modal-body">
                                <form method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="deskripsi" name="deskripsi" placeholder="Masukkan dekripsi_pekerjaan"><?php echo $data['deskripsi_pekerjaan']; ?></textarea>
                                    </div>
                            </div>
                            <div class="modal-footer">
                                <a href="<?php echo "delete_vacancy.php?id_lowongan=$data[id_lowongan]" ?>"><button type="button" name="hapus" class="btn btn-danger" onclick='return confirm("Apakah Anda Yakin?")'>Hapus</button></a>
