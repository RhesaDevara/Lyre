        ...
        <div class="container">
            <div class="row gy-5 gx-md-5">
                <div class="col-lg-8">
                    ...
                    <div class="mb-5">
                        <h4 class="mb-3">Soal Tes</h4> <input type="button" value="Tambah Soal" class="btn btn-primary" data-toggle="modal" data-target="#jumlahSoal">
                        <?php
                        $ups = 1;
                                    ...
                                    <div class="vacancy-item-container">
                                        <div class="d-flex flex-column">
                                            <div class="d-flex flex-row">
                                                ...
                                                <div class="ms-2">
                                                    <i class="fa-solid fa-pencil mt-1" role="button" data-bs-toggle="modal" data-bs-target='#ubahSoal<?php echo $ups; ?>'></i>
                                                </div>
                                            </div>
                                            <div>A. <?php echo $data1['pilihan_a']; ?></div>
                                            <div>B. <?php echo $data1['pilihan_b']; ?></div>
                                            <div>C. <?php echo $data1['pilihan_c']; ?></div>
                                            <div>D. <?php echo $data1['pilihan_d']; ?></div>
                                        </div>
                                        <div>Jawaban: <?php echo $data1['jawaban']; ?></div>
                                    </div>
                                </div>
                            </div>
                            <form method="post">
                                <!-- Modal ubah soal -->
                                <div class="modal fade" id="ubahSoal<?php echo $ups; ?>" tabindex="-1" role="dialog" aria-labelledby="ubahSoalLabel" aria-hidden="true">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <div class="form-group">
                                                    <label for="recipient-name" class="col-form-label">Pertanyaan:</label> <input type="text" name="id_soal" value="<?php echo $id_soal; ?>" hidden>
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <input type="submit" name="ubahSoal" class="btn btn-primary" value="Konfirmasi">
                                            </div>
                                        </div>
                                    </div>
                                </div>
